...
import HudCrosshair from '../aiming/HudCrosshair.vue'
import HudLogStream from '../text/HudLogStream.vue'
import HudMeterBar from '../specimen/HudMeterBar.vue'
import HudScanBuffer from '../codes/HudScanBuffer.vue'
import HudTargetLock from '../aiming/HudTargetLock.vue'
...
<template>
  <Story title="HUD / COMPOSITES / Motion">
