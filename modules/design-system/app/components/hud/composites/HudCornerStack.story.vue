...
<template>
  <Story title="HUD / COMPOSITES / HudCornerStack">
    <Variant title="Default">
      ...
      <template #controls>
        <HstText
          v-model="state.org.name"
          title="Org name"
        />
        <HstText
          v-model="state.org.meta"
          title="Org meta"
        />
        <HstText
          v-model="state.serial.serial"
          title="Serial"
        />
        <HstText
          v-model="state.serial.caption"
          title="Serial caption"
        />
      </template>
    </Variant>
